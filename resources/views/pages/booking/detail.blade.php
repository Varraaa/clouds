    ...
    <main class="relative flex flex-col w-full max-w-[1280px] px-[75px] mx-auto mt-[50px] mb-[62px]">
        ...
        <div class="flex gap-[30px] mt-[30px]">
                    ...
                    <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="text-end">
                                ...
                                <p class="font-semibold text-lg">
                                    {{ $transaction->passengers->count() }} people</p>
                            </div>
                        </div>
                    ...
                    <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">
                                    {{ 'Rp. ' . number_format($transaction->grandtotal - $transaction->subtotal + ($transaction->discount ?? 0), 0, ',', '.') }}
                                </p>
                            </div>
                            <div>
            ...
            <div id="Right-Content" class="flex flex-col gap-[30px] w-[490px] shrink-0">
                ...
                @foreach ($transaction->passengers as $passenger)
                    <div id="Passenger-{{ $loop->iteration }}"
                            ...
                            <div class="flex flex-col gap-[10px]">
                                ...
                                <div class="flex items-center rounded-full py-3 px-5 gap-[10px] bg-garuda-bg-grey">
                                    <img src="{{ asset('assets/images/icons/note-add-black.svg') }}"
                                        class="w-5 flex shrink-0" alt="icon">
                                    <p class="font-semibold">
                                        {{ \Carbon\Carbon::parse($passenger->date_of_birth)->format('d F Y') }}
                                    </p>
                                </div>
                            </div>
                ...
                <a href="{{ route('booking.downloadPDF', $transaction->code) }}"
